...
<div class="collapsible-sections">
    ...
    <div class="section-collapsible">
        <button class="section-toggle" data-section="languages">
            <span class="section-title">
                {{ t.about.languages_title }}
            </span>
            <span class="toggle-icon">▼</span>
        </button>
        <div class="section-content" id="languages" style="display: block;">
            {% for edu in education %}
            <div class="timeline-item">
                <div class="item-title">{{ edu.degree }}</div>
                <div class="item-meta">
...
<div class="section-content" id="experience" style="display: block;">
            ...
            <div class="timeline-item">
                <div class="item-title">{{ exp.title }}                 {% if exp.current %}
                <span class="item-badge current">Atual</span>
                {% endif %}</div>
                <div class="item-meta">
                    {{ exp.organization }}
                </div>
